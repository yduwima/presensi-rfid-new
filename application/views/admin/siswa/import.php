<div class="container mx-auto px-4 py-6">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?= base_url('admin/siswa') ?>" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <form action="<?= base_url('admin/siswa/process_import') ?>" method="post" enctype="multipart/form-data" class="space-y-4">
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <ul class="list-disc list-inside text-sm text-blue-600 mt-1">
                                    ...
                                    <li>Kelas ID harus sudah terdaftar</li>
            ...
            <div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded p-4 space-y-4">
                    <p class="text-sm text-gray-600">
                        Download template Excel untuk memudahkan proses import data siswa.
                    </p>

                    <a href="<?= base_url('admin/siswa/download_template') ?>" 
                    ...
                    <div class="mt-4">
                        ...
                        <div class="text-sm text-gray-600 space-y-1">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <strong>NIS</strong> - Nomor Induk Siswa (wajib, unik)
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                            ...
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>Jenis Kelamin</strong> - L atau P (wajib)
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>Tempat Lahir</strong> - Kota/kabupaten lahir
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>Tanggal Lahir</strong> - Format: YYYY-MM-DD
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                            ...
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>No HP Siswa</strong> - Nomor telepon siswa
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>Kelas ID</strong> - ID kelas (lihat di Data Kelas)
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>Nama Orang Tua</strong> - Nama wali/orang tua
                                </div>
                            </div>
                            <div class="flex items-start">
                                <i class="fas fa-check text-green-500 mr-2 mt-1"></i>
                                <div>
                                    <strong>No HP Orang Tua</strong> - Untuk notifikasi WA
                                </div>
                            </div>
                            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        <ul class="list-disc list-inside space-y-1">
                            <li>Data yang sudah ada (berdasarkan NIS) akan dilewati (tidak duplikat)</li>
